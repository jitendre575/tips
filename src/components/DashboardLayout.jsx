...
const DashboardLayout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen bg-[#0f212e] md:py-8 flex justify-center overflow-x-hidden">
            <div className="w-full max-w-[480px] bg-[#f5f5f9] min-h-screen flex flex-col relative shadow-2xl md:rounded-[30px] md:border-[8px] md:border-black">
                {/* Mobile Sidebar */}
                ...
                <div className="flex-1 flex flex-col w-full h-full overflow-hidden">
                    ...
                    <header className="sticky top-0 z-[100] bg-white/90 backdrop-blur-3xl border-b border-black/[0.05] h-16 px-4 flex items-center shrink-0 shadow-sm">
                        ...
                        <div className="flex-1 flex justify-start items-center">
                            <button
                                ...
                                className="p-2.5 bg-slate-50 border border-black/[0.05] rounded-[10px] text-slate-600 hover:text-accent transition-all active:scale-95 shadow-sm"
                            >
                                <Menu size={20} />
                            </button>
                        </div>
                    ...
                    <div className="flex-1 flex justify-end items-center gap-2">
                        <div className="bg-slate-50 px-3 py-1.5 rounded-[10px] border border-black/[0.05] flex items-center gap-2 shadow-inner hover:border-accent/30 transition-all group">
                            <div className="bg-amber-100 p-1.5 rounded-[10px]">
                        ...
                        <button
                            ...
                            className="w-10 h-10 flex items-center justify-center bg-accent text-white rounded-[10px] border border-accent/10 transition-all active:scale-90 shadow-lg shadow-accent/20 group"
                        >
