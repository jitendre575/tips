            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="hidden sm:flex items-center gap-1.5 px-3 py-1 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-500 rounded-[6px] border border-emerald-500/20 text-[10px] font-black uppercase tracking-widest transition-all"
                    >
                        <PlusCircle size={14} />
                        <span>Refill</span>
                    </button>

                    <div className="bg-zinc-900 px-4 py-2 rounded-[6px] border border-white/[0.05] flex items-center gap-2">
