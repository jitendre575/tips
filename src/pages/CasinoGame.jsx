...
const CasinoGame = () => {
    ...
    const renderGame = () => {
        if (!casinoSettings.activeGames.includes(gameId)) {
            return (
                <div className="flex flex-col items-center justify-center h-[500px] bg-zinc-900 shadow-2xl rounded-[6px] border border-red-500/20 text-center p-10">
                    <div className="w-20 h-20 bg-red-500/10 rounded-[6px] flex items-center justify-center text-red-500 mb-6 animate-pulse">
                        <ShieldAlert size={40} />
                    </div>
                    ...
                    <button onClick={() => navigate('/dashboard')} className="mt-10 px-10 py-4 bg-zinc-800 hover:bg-white text-zinc-400 hover:text-black rounded-[6px] font-black uppercase text-[10px] tracking-[4px] transition-all">LOBBY RECALL</button>
                </div>
            );
        }
        ...
        switch (gameId) {
            ...
            default:
                return (
                    <div className="flex flex-col items-center justify-center h-[500px] bg-zinc-900/50 rounded-[6px] border border-white/5 border-dashed">
                        ...
                        <button
                            ...
                            className="mt-8 px-8 py-4 bg-white/5 hover:bg-white/10 text-white rounded-[6px] font-black uppercase text-xs transition-all"
                        >
                            Back to Lobby
                        </button>
                    </div>
        ...
        <div className="animate-in fade-in duration-500" style={{ background: '#0f212e', minHeight: '100vh' }}>
            ...
            <div className="relative">
                ...
                <div className="absolute top-3 right-3 z-50">
                    <button
                        ...
                        className="p-2.5 bg-[#2f4553]/80 hover:bg-[#2f4553] backdrop-blur-md rounded-[6px] border border-white/10 text-white transition-all active:scale-90"
                    >
            ...
            <div className="px-4 sm:px-6 pb-8 pt-6 space-y-4" style={{ background: '#0f212e' }}>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-3">
                    <div className="bg-[#213743] rounded-[6px] p-3 sm:p-4 text-center border border-[#2f4553]/30">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 mx-auto rounded-[6px] bg-[#00e701]/10 flex items-center justify-center mb-2">
                    ...
                    <div className="bg-[#213743] rounded-[6px] p-3 sm:p-4 text-center border border-[#2f4553]/30">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 mx-auto rounded-[6px] bg-[#f59e0b]/10 flex items-center justify-center mb-2">
                    ...
                    <div className="bg-[#213743] rounded-[6px] p-3 sm:p-4 text-center border border-[#2f4553]/30">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 mx-auto rounded-[6px] bg-[#3b82f6]/10 flex items-center justify-center mb-2">
                ...
                {/* VIP Banner */}
                <div className="relative overflow-hidden rounded-[6px] p-5 sm:p-6 border border-[#2f4553]/30" style={{ background: 'linear-gradient(135deg, #1a3a4a 0%, #213743 50%, #1a2c38 100%)' }}>
                    <div className="absolute top-0 right-0 w-32 h-32 rounded-[6px] bg-[#00e701]/5 blur-3xl" />
                    <div className="absolute bottom-0 left-0 w-24 h-24 rounded-[6px] bg-[#3b82f6]/5 blur-3xl" />
                    <div className="relative z-10 flex items-center gap-4">
                        <div className="w-12 h-12 rounded-[6px] bg-gradient-to-br from-[#f59e0b] to-[#ef4444] flex items-center justify-center text-white text-xl shrink-0">
                            🏆
                        </div>
                        ...
                        <button onClick={() => navigate('/dashboard')} className="px-4 py-2 bg-[#00e701] hover:bg-[#1fff20] text-[#05200a] rounded-[6px] text-[10px] sm:text-xs font-black transition-all active:scale-95 shrink-0">
                            Explore
                        </button>
                    </div>
                </div>
                ...
                <button
                    ...
                    className="w-full py-3 bg-[#213743] hover:bg-[#2f4553] text-[#b1bad3] rounded-[6px] text-xs font-bold transition-all flex items-center justify-center gap-2 border border-[#2f4553]/30"
                >
                    <ArrowLeft size={14} />
                    Back to Game Lobby
                </button>
