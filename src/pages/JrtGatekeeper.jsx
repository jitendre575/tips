...
const JrtGatekeeper = ({ onAuthorized }) => {
    ...
    return (
        <div className="min-h-screen bg-primary flex items-center justify-center p-6 relative overflow-hidden">
            {/* Background Effects */}
            <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-accent/10 blur-[150px] rounded-full animate-pulse" />
            <div className="absolute bottom-0 left-0 w-[30%] h-[30%] bg-accent/5 blur-[120px] rounded-full" />
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-5xl font-black italic tracking-tighter uppercase mb-2">
                        System <span className="logo-accent">Override</span>
                    </h1>
                ...
                <form onSubmit={handleAccess} className="space-y-6">
                    <div className="relative group">
                        <ShieldCheck className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-700 group-focus-within:text-accent transition-colors" size={24} />
                        <input
                            type="password"
